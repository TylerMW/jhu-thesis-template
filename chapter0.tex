...
This thesis reports experimental studies of the rheology of biological materials, with an emphasis on interfacial materials, including protein layers and bacterial biofilms. Results are presented on layers formed by the proteins lysozyme Staphylococcal nuclease at the air--water interface, on biofilms formed by Pseudomonas bacteria at the oil--water interface, and on the bulk rheological properties of fibrin and cystic fibrosis mucus. A major focus of the work is establishing a connection between the evolution of the mechanical response through time and underlying structural changes.

The studies employ interfacial microrheology, which uses the motion of micrometer-scale particles embedded in the interface to probe the mechanical response of the surrounding material and infer its rheology. Passive measurements, which rely on thermal forces to drive the particles, are complemented by active measurements, in which ferromagnetic nanowires were rotated using magnetic fields. Additionally, the last study described employs a novel technique using custom fluorescent particles that can be selectively ``switched on'' and used to characterize rheology and particle mobility over large time and distance scales.
...
This work was conducted under the advisement of Professor Robert L. Leheny and Professor Daniel H. Reich.
